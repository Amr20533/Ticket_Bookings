...
const Color kGreyColor = Color(0xFFA9AAB1);
const Color kDividerColor = Color(0xFFF5F5F6);


const Color kBottomBoxColor = Color(0xFFF37B67);
const Color kTitleColor = Color(0xFFd2bdb6);
const Color kPrimaryButtonColor = Color(0xFF5565FF);
...
const Color kYellowColor = Color(0xFFF3C32F);
